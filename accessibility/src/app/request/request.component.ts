...
export class RequestComponent implements OnInit {
  ...
  async newRequest() {
    ...
    if (this.course !== undefined && this.type !== undefined &&
      this.lms !== undefined && this.media !== undefined &&
      this.title !== undefined && this.priority !== undefined &&
      (this.name !== undefined || !this.auth.user.isAnonymous)) {
      if (this.auth.user.isAnonymous) {
      ...
      if (this.course !== '' && this.type !== '' &&
        ...
        (this.name !== '' || !this.auth.user.isAnonymous)) {
        ...
        try {
          ...
          if (this.name === undefined) {
            alert('Please fill put in your name as the Requester');
          } else {
        ...
        if (this.name === '' && this.media === '') {
          alert('Please fill put in your name as the Requester and information');
        } else if (this.name === '') {
          alert('Please fill put in your name as the Requester');
        } else {
          alert('Please fill in all fields');
      ...
      if (this.name === undefined && this.media === undefined) {
        alert('Please fill put in your name as the Requester and information');
